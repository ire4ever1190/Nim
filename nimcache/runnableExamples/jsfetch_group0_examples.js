...
function nimCopy(dest_p0, src_p1, ti_p2) {
  var result_33557332 = null;
    ...
    case 5:
      ...
      result_33557332 = src_p1;
      }
      else {
        result_33557332 = [src_p1[0], src_p1[1]];
      }
    ...
    case 19:
      ...
      result_33557332 = dest_p0;
    
      break;
    case 18:
    case 17:
      if (!((ti_p2.base == null))) {
      result_33557332 = nimCopy(dest_p0, src_p1, ti_p2.base);
      }
      else {
      if ((ti_p2.kind == 17)) {
      result_33557332 = (dest_p0 === null || dest_p0 === undefined) ? {m_type: ti_p2} : dest_p0;
      }
      else {
        result_33557332 = (dest_p0 === null || dest_p0 === undefined) ? {} : dest_p0;
      }
      }
      nimCopyAux(result_33557332, src_p1, ti_p2.node);
      break;
    case 4:
    case 16:
        ...
        if (src_p1 === null) {
          ...
          for (var i = 0; i < src_p1.length; ++i) {
            result_33557332[i] = nimCopy(result_33557332[i], src_p1[i], ti_p2.base);
          }
        }
      }
    ...
    case 28:
            if (src_p1 !== null) {
        result_33557332 = src_p1.slice(0);
      }
...
function isObj(obj_p0, subclass_p1) {
  var result_33557433 = false;

  BeforeRet: {
    var x_33557434 = obj_p0;
    if ((x_33557434 == subclass_p1)) {
    result_33557433 = true;
    break BeforeRet;
    }
    
    Label1: {
        Label2: while (true) {
        if (!!((x_33557434 == subclass_p1))) break Label2;
          if ((x_33557434 == null)) {
          result_33557433 = false;
          break BeforeRet;
          }
          
          x_33557434 = x_33557434.base;
        }
    };
    result_33557433 = true;
    break BeforeRet;
  ...
  return result_33557433;

}

function toJSStr(s_p0) {
  var result_33556921 = null;

    var res_33556987 = newSeq_u9__system((s_p0).length);
    var i_33556988 = 0;
    var j_33556989 = 0;
    Label1: {
        Label2: while (true) {
        if (!(i_33556988 < (s_p0).length)) break Label2;
          ...
          i_33556988 += 1;
            ...
            var helper_33557012 = newSeq_u9__system(0);
            Label3: {
                Label4: while (true) {
                if (!true) break Label4;
                  var code_33557013 = c_33556990.toString(16);
                  if ((((code_33557013) == null ? 0 : (code_33557013).length) == 1)) {
                  helper_33557012.push("%0");;
                  }
                  else {
                  helper_33557012.push("%");;
                  }
                  
                  helper_33557012.push(code_33557013);;
                  i_33556988 += 1;
...
++excHandler;
            try {
            res_33556987[j_33556989] = decodeURIComponent(helper_33557012.join(""));
--excHandler;
} catch (EXCEPTION) {
 ...
 --excHandler;
            raiseDefect();
            res_33556987[j_33556989] = helper_33557012.join("");
    ...
    result_33556921 = res_33556987.join("");

  return result_33556921;
...
function reprEnum(e_p0, typ_p1) {
  ...
  framePtr = F;
    ...
    var tmp_33557617 = false;
    F.line = 31;
    var item_33557618 = typ_p1.node.sons[e_p0];
    F.line = 32;
    tmp_33557617 = item_33557618 !== undefined;
    if (tmp_33557617) {
    F.line = 34;
    result_33557616 = nimCopy(null, makeNimstrLit(item_33557618.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557616 = nimCopy(null, (HEX24_u1__systemZdollars(e_p0)).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41]), NTI33554449);
    }
...
function isFatPointer_u0__system(ti_p0) {
  var result_33557314 = false;

  BeforeRet: {
    result_33557314 = !((ConstSet1[ti_p0.base.kind] != undefined));
    break BeforeRet;
  };
...
function auxWriteStackTrace_u0__system(f_p0) {
  var result_33556533 = [[]];
    ...
    var it_33556538 = f_p0;
    var i_33556539 = 0;
    var total_33556540 = 0;
    var tempFrames_33556541 = arrayConstr(64, {Field0: null, Field1: 0, Field2: null}, NTI33555871);
    Label1: {
        Label2: while (true) {
        if (!(!((it_33556538 == null)) && (i_33556539 <= 63))) break Label2;
          tempFrames_33556541[i_33556539].Field0 = it_33556538.procname;
          tempFrames_33556541[i_33556539].Field1 = it_33556538.line;
          tempFrames_33556541[i_33556539].Field2 = it_33556538.filename;
          i_33556539 += 1;
          total_33556540 += 1;
          it_33556538 = it_33556538.prev;
        }
    };
    Label3: {
        Label4: while (true) {
        if (!!((it_33556538 == null))) break Label4;
          total_33556540 += 1;
          it_33556538 = it_33556538.prev;
        }
    };
    result_33556533[0] = nimCopy(null, [], NTI33554449);
    if (!((total_33556540 == i_33556539))) {
    nimAddStrStr(result_33556533[0], [40]);;
    nimAddStrStr(result_33556533[0], HEX24_u1__systemZdollars((total_33556540 - i_33556539)));;
    nimAddStrStr(result_33556533[0], [32,99,97,108,108,115,32,111,109,105,116,116,101,100,41,32,46,46,46,10]);;
    }
    
    Label5: {
      var j_33556570 = 0;
      var colontmp__687866295 = 0;
      colontmp__687866295 = (i_33556539 - 1);
      var res_687866297 = colontmp__687866295;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_687866297)) break Label7;
            j_33556570 = res_687866297;
            nimAddStrStr(result_33556533[0], cstrToNimstr(tempFrames_33556541[j_33556570].Field2));;
            if ((0 < tempFrames_33556541[j_33556570].Field1)) {
            nimAddStrStr(result_33556533[0], [40]);;
            addInt_u2__stdZprivateZdigitsutils(result_33556533, 0, tempFrames_33556541[j_33556570].Field1);
            if (false) {
            nimAddStrStr(result_33556533[0], [44,32]);;
            addInt_u2__stdZprivateZdigitsutils(result_33556533, 0, 0);
            }
            
            nimAddStrStr(result_33556533[0], [41]);;
            }
            
            nimAddStrStr(result_33556533[0], [32,97,116,32]);;
            add_u4__system(result_33556533, 0, tempFrames_33556541[j_33556570].Field0);
            nimAddStrStr(result_33556533[0], [10]);;
            res_687866297 -= 1;
          }
      };
    };
...
function rawWriteStackTrace_u0__system() {
  var result_33556623 = [];
    ...
    if (!((framePtr == null))) {
    result_33556623 = nimCopy(null, ([84,114,97,99,101,98,97,99,107,32,40,109,111,115,116,32,114,101,99,101,110,116,32,99,97,108,108,32,108,97,115,116,41,10]).concat(auxWriteStackTrace_u0__system(framePtr)), NTI33554449);
    }
    else {
      result_33556623 = nimCopy(null, [78,111,32,115,116,97,99,107,32,116,114,97,99,101,98,97,99,107,32,97,118,97,105,108,97,98,108,101,10], NTI33554449);
    }
...
function getCurrentException() {
  var result_33556465 = null;

    if (isNimException_u0__system()) {
    result_33556465 = lastJSError;
    }
...
function raiseDefect() {
    if (isNimException_u0__system()) {
    var e_33556670 = getCurrentException();
    if (isObj(e_33556670.m_type, NTI33555176)) {
    if ((excHandler == 0)) {
    unhandledException(e_33556670);
    }
    
    e_33556670.trace = nimCopy(null, rawWriteStackTrace_u0__system(), NTI33554449);
    throw e_33556670;
    }
...
function unhandledException(e_p0) {
    ...
    nimAddStrStr(buf_33556664[0], [69,114,114,111,114,58,32,117,110,104,97,110,100,108,101,100,32,101,120,99,101,112,116,105,111,110,58,32]);;
    nimAddStrStr(buf_33556664[0], e_p0.message);;
    }
    else {
    nimAddStrStr(buf_33556664[0], [69,114,114,111,114,58,32,117,110,104,97,110,100,108,101,100,32,101,120,99,101,112,116,105,111,110]);;
    }
    
    nimAddStrStr(buf_33556664[0], [32,91]);;
    add_u4__system(buf_33556664, 0, e_p0.name);
    nimAddStrStr(buf_33556664[0], [93,10]);;
    nimAddStrStr(buf_33556664[0], rawWriteStackTrace_u0__system());;
